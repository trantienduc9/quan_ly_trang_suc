	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_product"><i class="fa fa-plus"></i> Thêm mới</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	_conf("Bạn có chắc chắn xóa sản phẩm này?","delete_product",[$(this).attr('data-id')])
	})
	})
