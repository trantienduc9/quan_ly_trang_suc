			...
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">Tên đệm</label>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label for="" class="control-label">Vai trò người dùng</label>
						...
						<div class="form-group">
							...
							<small><i><?php echo isset($id) ? "Bỏ trống nếu bạn không muốn đổi mật khẩu":'' ?></i></small>
						</div>
						<div class="form-group">
