...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Kích thước có sẵn</label>
            </div>
            ...
            <div class="form-group">
              <div class="d-flex justify-content-end w-100">
                <button class="btn btn-flat bg-light border" type="button" id="add_size"><i class="fa fa-plus"></i> Thêm kích thước</button>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Màu có sẵn</label>
            </div>
            <?php if(isset($id) && $id > 0): ?>
            <?php 
            ...
            <div class="form-group">
              <div class="d-flex justify-content-end w-100">
                <button class="btn btn-flat bg-light border" type="button" id="add_color"><i class="fa fa-plus"></i> Thêm màu</button>
              </div>
            </div>
          </div>
        </div>
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-product">Lưu</button>
