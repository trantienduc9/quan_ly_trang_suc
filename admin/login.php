...
<head>
  ...
  <title>Đăng nhập | Cửa hàng trang sức Hà Đây</title>
...
<body class="bg-dark">
  ...
  <main id="main" >
		...
		<h4 class="text-white text-center"><b>Cửa hàng trang sức Hà Đây - Admin</b></h4>
		...
		$('#login-form button[type="button"]').removeAttr('disabled').html('Login');
			...
			success:function(resp){
				if(resp == 1){
					...
					$('#login-form').prepend('<div class="alert alert-danger">Tài khoản hoặc mật khẩu không chính xác.</div>')
					$('#login-form button[type="button"]').removeAttr('disabled').html('Login');
				}
			}
		})
