...
<div class=" col-lg-7">
  <div class="register-logo">
    <a href="#"><b>Cửa hàng trang sức Hà Đây </b></a>
  </div>
<?php session_start() ?>
	      ...
	      <div class="col-md-12">
	      	<div class="row">
	      		<div class="col-md-6 border-right">
			        ...
			        <div class="input-group mb-3">
			          <input type="text" class="form-control" name="middlename"  placeholder="Tên đệm" value="<?php echo isset($middlename) ? $middlename : '' ?>">
			          <div class="input-group-append">
			            <div class="input-group-text">
			              <span class="fas fa-user"></span>
			            </div>
	      		...
	      		<div class="col-md-6">
					...
					<?php endif; ?>
			        <div class="input-group mb-3">
			          <input type="password" class="form-control" name="cpass" <?php echo isset($id) ? '' : "required" ?> placeholder="Nhập lại mật khẩu">
			          <div class="input-group-append">
			            <div class="input-group-text">
			              <span class="fas fa-lock"></span>
			            </div>
          ...
          <div class="col-8">
            ...
            <div class="icheck-primary">
              ...
              <label for="agreeTerms">
               Tôi đồng ý với <a href="#">Điều Khoản này</a>
              </label>
            </div>
			<?php endif; ?>
		...
		$('[name="password"],[name="cpass"]').keyup(function(){
			...
			if(cpass == '' ||pass == ''){
				...
				if(cpass == pass){
					...
					$('#pass_match').attr('data-status','2').html('<i class="text-danger">Mật khẩu không phù hợp.</i>')
				}
			}
		})
	})
