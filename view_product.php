          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6">
              ...
              <div class="bg-gray disabled py-2 px-3 mt-4">
                <h2 class="mb-0">
                  <?php echo number_format($price,3) ?>
                </h2>
          ...
          <div class="row mt-4">
            <nav class="w-100">
              <div class="nav nav-tabs" id="product-tab" role="tablist">
                ...
                <a class="nav-item nav-link" id="product-comments-tab" data-toggle="tab" href="#product-cat-desc" role="tab" aria-controls="product-cat-desc" aria-selected="false">Mô tả danh mục</a>
              </div>
            </nav>
      ...
      $('#add_to_cart').click(function(){
        ...
        $.ajax({
            ...
            success:function(resp){
                if(resp == 1){
                    alert_toast("Sản phẩm được thêm vào giỏ hàng thành công.","success")
                    end_load()
                    load_cart()
                }
            }
